...
contract FeedbackManager {
    ...
    function respondToTask(
        ...
        bytes32 messageHash = keccak256(
            abi.encodePacked(sentiment, task.comment, task.rating)
        );
        ...
        // emitting event
        emit TaskResponded(referenceTaskIndex, task, sentiment, msg.sender);
    }
}
